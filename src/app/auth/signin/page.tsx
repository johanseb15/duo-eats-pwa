    ...
    <div className="flex flex-col min-h-screen bg-background pb-28">
      ...
      <main className="flex-grow container mx-auto px-4 py-6 flex flex-col items-center justify-center text-center">
        ...
        <div className="w-full max-w-xs space-y-4">
          <Button onClick={handleSignIn} size="lg" className="w-full rounded-full">
           ...
           <Link href="/auth/forgot-password" passHref>
             <Button variant="link" className="text-sm text-muted-foreground">¿Olvidaste tu contraseña?</Button>
           </Link>
        </div>
      </main>
      <BottomNav />
